...
impl TryFrom<u8> for HouseSystem {
    ...
    fn try_from(v: u8) -> std::result::Result<Self, Self::Error> {
        match v {
            b'A' | b'E' | b'a' | b'e' => Ok(Self::Equal),
            b'B' | b'b' => Ok(Self::Alcabitius),
            b'C' | b'c' => Ok(Self::Campanus),
            b'D' | b'd' => Ok(Self::EqualMC),
            b'F' | b'f' => Ok(Self::Carter),
            b'G' | b'g' => Ok(Self::Gauquelin),
            b'H' | b'h' => Ok(Self::Horizon),
            b'I' => Ok(Self::Sunshine),
            b'i' => Ok(Self::SunshineAlt),
            b'J' | b'j' => Ok(Self::SavardA),
            b'K' | b'k' => Ok(Self::Koch),
            b'L' | b'l' => Ok(Self::PullenSD),
            b'M' | b'm' => Ok(Self::Morinus),
            b'N' | b'n' => Ok(Self::EqualAries),
            b'O' | b'o' => Ok(Self::Porphyry),
            b'P' | b'p' => Ok(Self::Placidus),
            b'Q' | b'q' => Ok(Self::PullenSR),
            b'R' | b'r' => Ok(Self::Regiomontanus),
            b'S' | b's' => Ok(Self::Sripati),
            b'T' | b't' => Ok(Self::PolichPage),
            b'U' | b'u' => Ok(Self::KrusinskiPisaGoelzer),
            b'V' | b'v' => Ok(Self::Vehlow),
            b'W' | b'w' => Ok(Self::WholeSign),
            b'X' | b'x' => Ok(Self::Meridian),
            b'Y' | b'y' => Ok(Self::APC),
